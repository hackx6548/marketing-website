...
const { isAdmin, isSuperAdmin } = require("../../helpers/helper");
...
module.exports.getStories = async function(req, res) {
  ...
  const query = isSuperAdmin(req) ? { userId: req.user._id } : {};
...
module.exports.editStory = async function(req, res) {
  const query = isSuperAdmin(req)
    ? { userId: req.user._id, slug: req.params.slug }
...
module.exports.createStory = async (req, res) => {
  ...
  story.companylogo = req.files.companylogo
