...
router.post("/", ensureAuthenticated, redirectNonAdmin, AdminLocationsController.uploadImages, AdminLocationsController.resizeImages, AdminLocationsController.createLocation);
router.delete("/delete/:id", ensureAuthenticated, redirectNonAdmin, AdminLocationsController.deleteLocation);
router.put("/update/:id", ensureAuthenticated, redirectNonAdmin, AdminLocationsController.uploadImages, AdminLocationsController.resizeImages, AdminLocationsController.updateLocation);
