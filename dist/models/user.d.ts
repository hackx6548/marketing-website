declare const _exports: {
    ...
    createUser: (newUser: any, callback: any) => void;
    getUserByEmail: (email: any, callback: any) => void;
    getUserById: (id: any, callback: any) => void;
    comparePassword: (candidatePassword: any, hash: any, callback: any) => void;
};
export = _exports;
export function createUser(newUser: any, callback: any): void;
export function getUserByEmail(email: any, callback: any): void;
export function getUserById(id: any, callback: any): void;
export function comparePassword(candidatePassword: any, hash: any, callback: any): void;
