...
exports.pages = [
        ...
        content: {
            ops: [
                ...
                { attributes: { header: 1 }, insert: "\n" },
                {
                    ...
                    insert: {
                        image: "https://www.digitalcareerinstitute.org/wp-content/uploads/2017/04/AZAV_schwarz-wei%C3%9F-ICG-300x274-1-150x150.png"
                    }
                },
                { attributes: { header: 1 }, insert: "\n" },
                {
    ...
    },
    {
        ...
        content: {
            ops: [
                {
                    insert: "Digital Career Institute doesn’t only qualify refugees but also helps to integrate them. To keep ambitions and motivation of the participants high, we want to place a spiritual coach, a buddy, at their sides – you!\n"
                },
